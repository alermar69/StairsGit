...
if(params.isCarcas != "нет"){
	materials.sheet4.amt += (getPartPropVal('treadFrame', 'area') + getPartPropVal('wndFrame1', 'area') + getPartPropVal('wndFrame2', 'area') + getPartPropVal('wndFrame3', 'area')) * 3; //к-т 3 учитывает 2 стороны и ребра
}	
