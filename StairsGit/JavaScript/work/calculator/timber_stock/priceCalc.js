var costMarkup = 1.3; //07.05 было 1.0;

function calculateCarcasPrice(){

if(params.timberPaint != "не указано" && params.timberPaint != "нет") costMarkup = 1.25;
...
if (M > 1200) strigerPrice = strigerPrice * 1.5; //добавляется третий косоур
	...
	var carcasPlateName = calcTimberParams(params.stringersMaterial).treadsPanelName;
	var stringerMeterPrice = calcTimberParams(params.stringersMaterial).m2Price_40;
