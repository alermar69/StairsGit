...
<tr class="marsh2"><td>Ограждения среднего марша:</td> <td> 
...
<tr class="marsh2"><td>Пристенный поручень среднего марша:</td> <td> 
	<select id="handrailSide_2" size="1" onchange="">
			<option value="нет">нет</option>
			<option value="внешнее"  >внешняя сторона</option>
			<option value="внутреннее">внутренняя сторона</option>
			<option value="две">две стороны</option>			
...
<tr class="pltP"><td>Заднее ограждение промежуточной площадки:</td> <td> 
...
<tr class="pltP"><td>Пристенный поручень промежуточной площадки:</td> <td> 
	<select id="backHandrail_1" size="1" onchange="">
		<option value="нет">нет</option>
		<option value="есть">есть</option>
	</select>
</td></tr>

<tr class="wndP"><td>Заднее ограждение забега:</td> <td> 
...
<tr class="wndP"><td>Пристенный поручень забега:</td> <td> 
	<select id="backHandrail_2" size="1" onchange="">
		<option value="нет">нет</option>
		<option value="есть">есть</option>
	</select>
</td></tr>
