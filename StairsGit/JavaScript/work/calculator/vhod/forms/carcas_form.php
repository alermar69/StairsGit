		...
		<div id="carcasTableWrapper" class='editionsChangeForm'>
			...
			<table class="form_table">
				<tbody>
					...
					<tr id="stairModel_tr">
						...
						<td>
							<select id="stairModel" size="1">
								...
								<option value="Прямая с промежуточной площадкой">Прямая с промежуточной площадкой
								</option>
					...
					<tr>
						<td>Боковой добор верхней площадки:</td>
						<td>
					...
					<tr>
						<td>Ширина бокового добора верхней площадки:</td>
						<td>
					...
					<tr id="stairFrame_tr" class="custom">
		...
		<div id="assembling_inputs" class='editionsChangeForm'>
			...
			<table class="form_table">
				<tbody>
					...
					<tr>
						<td>Колонны наверху лестницы:</td>
						<td>
					...
					<tr class="custom">
						<td>Крепление подкосов средней площадки:</td>
						<td>
