...
<?php 
	...
	//справочники
	$timberTypes = file_get_contents($_SERVER['DOCUMENT_ROOT']."/calculator/general/forms/timberTypes.php");
	$timberPaint = file_get_contents($_SERVER['DOCUMENT_ROOT']."/calculator/general/forms/timberPaint.php");
	$timberColors = file_get_contents($_SERVER['DOCUMENT_ROOT']."/calculator/general/forms/timberColors.php");
	
	$metalTypes = file_get_contents($_SERVER['DOCUMENT_ROOT']."/calculator/general/forms/metalTypes.php");
	$metalPaint = file_get_contents($_SERVER['DOCUMENT_ROOT']."/calculator/general/forms/metalPaint.php");
	$metalColors = file_get_contents($_SERVER['DOCUMENT_ROOT']."/calculator/general/forms/metalColors.php");

	$pvcTypes = '<option value="ПВХ">ПВХ</option>';
	$pvcPaint = '<option value="нет">нет</option>';
	$pvcColors = file_get_contents($_SERVER['DOCUMENT_ROOT']."/calculator/general/forms/pvcColors.php");
