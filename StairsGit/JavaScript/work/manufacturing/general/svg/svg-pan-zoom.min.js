...
SvgPanZoom.prototype.handleMouseWheel = function(evt) {
  ...
  var relativeMousePoint = SvgUtils.getEventPoint(evt, this.svg).matrixTransform(
      inversedScreenCTM
    ),
...
SvgPanZoom.prototype.zoomAtPoint = function(zoomScale, point, zoomAbsolute) {
  ...
  try {
    var matrix = oldCTM.inverse();
  } catch (error) {
    var matrix = oldCTM
  }
  var relativePoint = point.matrixTransform(matrix),
    modifier = this.svg
      .createSVGMatrix()
...
SvgPanZoom.prototype.handleMouseMove = function(evt) {
  ...
  if (this.state === "pan" && this.options.panEnabled) {
	...
	try {
		...
		var point = SvgUtils.getEventPoint(evt, this.svg).matrixTransform(this.firstEventCTM)
	}
