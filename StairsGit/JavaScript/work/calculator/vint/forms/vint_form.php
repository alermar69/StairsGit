<div id="carcasFormWrap">
	...
	<div id="carcasForm" class="toggleDiv">
		...
		<tr class="timberPaint timberColor"><td>Морилка:</td> <td> 
		...
		<table class="form_table" id="midHoldersTable"><tbody>	

			<tr><td>Ограждение лестницы:</td> <td> 
			...
			<tr class='railingParams'><td>Модель ограждения:</td> <td> 
			...
			<tr class="railingParams rigelParams"><td>Материал ригелей:</td> <td> 
			...
			<tr class="railingParams rigelParams"><td>Кол-во ригелей:</td> <td>
			...
			<tr  class="railingParams glassParams"><td>Крепление поручня на стекло:</td> <td> 
		...
		<table class="form_table" id="midHoldersTable"><tbody>
		<tr>
			<th>№ крепления</th><th>Угол</th><th>Длина</th><th>№ ступени</th>
		<tr>
		<tr class="midHolder">
			<td>1</td>
