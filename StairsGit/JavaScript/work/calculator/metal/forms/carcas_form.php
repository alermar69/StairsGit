<div id="carcasFormWrap">
	...
	<div id="carcasForm" class="toggleDiv">
		...
		<div id='carcasTableWrapper' class='editionsChangeForm'>
			...
			<table class="form_table">
				<tbody>
					...
					<tr id="marshDist_tr">
						<td>Зазор между маршами в плане:</td>
						<td>
					...
					<tr id="stringerDivision_tr" style="display: none">
						<td>Разделение косоуров промежуточной площадки:</td>
						<td>
					...
					<tr class="P3marsh">
						<td>Разделение косоуров второй промежуточной площадки:</td>
						<td>
					...
					<tr class="topPlt">
						<td>Разделение косоуров верхней площадки:</td>
						<td>
					...
					<tr>
						<td>Ширина последней забежной ступени:</td>
						<td><input id="lastWinderTreadWidth" type="number" value="100"></td>
					</tr>

					<tr class="topPlt">
						<td>Задняя тетива площадки:</td>
						<td>
					...
					<tr>
						<td>Боковой свес ступеней, мм:</td>
						<td>
					...
					<tr>
						<td>Передний свес ступеней, мм:</td>
						<td>
			...
			<div id="complect_inputs">
				...
				<table class="form_table">
					<tbody>
						...
						<tr>
							<td>Пластиковые колпачки на гайки:</td>
							<td>
						...
						<tr class="marsh1 stringerCover">
							<td>Накладки нижнего марша:</td>
							<td>
						...
						<tr class="marsh2 stringerCover">
							<td>Накладки среднего марша:</td>
							<td>
						...
						<tr class="marsh3 stringerCover">
							<td>Накладки верхнего марша:</td>
							<td>
		...
		<div id="assembling_inputs" class='editionsChangeForm'>
			...
			<table class="form_table">
				<tbody>
					...
					<tr id="columnPos_tr">
						<td>Крепление колонн к косоурам:</td>
						<td>
					...
					<tr class="topFixParams">
						<td>Тип крепления к верхнему перекрытию:</td>
						<td>
					...
					<tr class="topFixParams">
						<td>Фланец крепления к верхнему перекрытию:</td>
						<td>
					...
					<tr>
						<td>Тип крепления к нижнему перекрытию:</td>
						<td>
					...
					<tr class="marsh1 skirting">
						<td>Плинтус нижнего марша:</td>
						<td>
					...
					<tr class="marsh2 skirting">
						<td>Плинтус среднего марша:</td>
						<td>
					...
					<tr class="marsh3 skirting">
						<td>Плинтус верхнего марша:</td>
						<td>
					...
					<tr class="wndP skirting">
						<td>Плинтус внешней стороны забега:</td>
						<td>
					...
					<tr class="pltP skirting">
						<td>Плинтус сзади промежуточной площадки:</td>
						<td>
					...
					<tr>
						<td>Отверстия для обшивки каркаса:</td>
						<td>
		...
		<div id="manufacturingParams" class='editionsChangeForm'>
