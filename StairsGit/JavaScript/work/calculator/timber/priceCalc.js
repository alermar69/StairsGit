...
var stringerMaterial = params.stringersMaterial;
...
if (M > 1200) strigerPrice = strigerPrice * 1.5; //добавляется третий косоур
	...
	if (stairModel == "Прямая") cncCarcasPartsAmt = 4+4; //вторые 4 это разделение длинных маршей
	if (stairModel == "Г-образная с площадкой") cncCarcasPartsAmt = 7+4;
	if (stairModel == "Г-образная с забегом") cncCarcasPartsAmt = 7+4;
	if (stairModel == "П-образная с площадкой") cncCarcasPartsAmt = 10+4;
	if (stairModel == "П-образная с забегом") cncCarcasPartsAmt = 10+4;
	if (stairModel == "П-образная трехмаршевая") cncCarcasPartsAmt = 10+4;
